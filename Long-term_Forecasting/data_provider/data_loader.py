...
from . import noise_transforms as transforms
...
class Dataset_Custom(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 ...
                 target='OT', scale=True, timeenc=0, freq='h',
                 percent=10, max_len=-1, train_all=False,
                 noise=None, noise_drift=None, noise_var=None, noise_scale=1.):
        # size [seq_len, label_len, pred_len]
        # info
        if size == None:
            self.seq_len = 24 * 4 * 4
...
class Dataset_Custom_Test(Dataset):
    def __init__(self, root_path, flag='train', size=None,
        ...
        self.add_noise_transform(noise, noise_drift, noise_var, noise_scale)
